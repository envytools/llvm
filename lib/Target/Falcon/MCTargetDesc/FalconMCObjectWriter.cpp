...
static unsigned getAbsoluteReloc(MCContext &Ctx, const MCFixup &Fixup) {
  ...
  case FK_Data_1: return ELF::R_FALCON_8;
  case FK_Data_2: return ELF::R_FALCON_16;
  case FK_Data_4: return ELF::R_FALCON_32;
  case Falcon::FK_FALCON_8: return ELF::R_FALCON_8;
  case Falcon::FK_FALCON_16: return ELF::R_FALCON_16;
  case Falcon::FK_FALCON_24: return ELF::R_FALCON_24;
  case Falcon::FK_FALCON_32: return ELF::R_FALCON_32;
  case Falcon::FK_FALCON_S8: return ELF::R_FALCON_S8;
  case Falcon::FK_FALCON_S16: return ELF::R_FALCON_S16;
  ...
  case Falcon::FK_FALCON_8S1: return ELF::R_FALCON_8S1;
  case Falcon::FK_FALCON_8S2: return ELF::R_FALCON_8S2;
  default:
...
static unsigned getPCRelReloc(MCContext &Ctx, const MCFixup &Fixup) {
  ...
  case FK_Data_1:
  case FK_PCRel_1: return ELF::R_FALCON_PC8;
  case Falcon::FK_FALCON_S16:
  case FK_Data_2:
  case FK_PCRel_2: return ELF::R_FALCON_PC16;
  case Falcon::FK_FALCON_32:
  case FK_Data_4:
  case FK_PCRel_4: return ELF::R_FALCON_PC32;
  default:
